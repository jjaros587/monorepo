...
export type GenericMorph = Article | Category | ComponentSectionsHero | ComponentSharedSeo | Country | Global | Homepage | I18NLocale | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser | Writer;
...
export type Homepage = {
  ...
  title: Scalars['String'];
  updatedAt?: Maybe<Scalars['DateTime']>;
  wallpapers: UploadFileRelationResponseCollection;
};


export type HomepageWallpapersArgs = {
...
export type HomepageInput = {
  ...
  title?: InputMaybe<Scalars['String']>;
  wallpapers?: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
};
