...
export const MarkdownImage: React.FC<ImgHTMLAttributes<HTMLImageElement>> = ({ src, alt }) => {
  ...
  return (
    <Box align="center">
      <Container paddingX="L">
        <Image src={url} alt={alt} fill={true} quality={1} className="image" onClick={handleOpen} />
      </Container>
