...
import { IconButton, PaginationWithPageInfo, TextInput, Text, Inline, NumberInput } from '@ui'
...
export const PageSwitcher = ({ pagination }: { pagination: PaginationWithPageInfo }) => {
  const { hasNextPage, totalCount, pageSize, pageNumber, setPreviousPage, setNextPage, setPage } = pagination
