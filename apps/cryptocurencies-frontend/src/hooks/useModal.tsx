...
import React, { createContext, isValidElement, useContext, useState, useMemo, useEffect } from 'react'
...
export const ModalContextProvider: React.FC = ({ children }) => {
  ...
  return <ModalContext.Provider value={{ modal, showModal, closeModal, confirm }}>{children}</ModalContext.Provider>
}
